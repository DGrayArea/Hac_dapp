...
const Hac333 = () => {
  ...
  return (
    <div className="bg-black min-h-screen mx-auto">
        ...
        <Staking tokenC={'0x7E82F54578f03ad922F2bA61674C46b9dBdCE61d'} vaultC={'0x60a00a6d716e2c2F896698B28dC1a7a508f0b87A'}  name={'Hac 333 Staking'} vaultId={0} contract={nftContract} token={token} cardName={'Hac 333'}  />
        </div>
      </div>
  )
}
