...
const Hac333 = () => {
  ...
  return (
    <div className="bg-black min-h-screen mx-auto">
        ...
        <Staking tokenC={'0xE33cc98d90975Ad42e56251B0A1cd8bda9FAF003'}  token={token} vaultC={'0x4d2Bfa7d1D13e6C13A08a92B32a238b2B6DFFE0E'}  name={'Hac Aliens Staking'} vaultId={2} contract={contract} cardName={'Hac Aliens'}  />
        </div>
      </div>
  )
}
