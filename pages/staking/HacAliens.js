...
const Hac333 = () => {
  ...
  return (
    <div className="bg-black min-h-screen mx-auto">
        ...
        <Staking tokenC={'0xE33cc98d90975Ad42e56251B0A1cd8bda9FAF003'}  token={token} vaultC={'0x60a00a6d716e2c2F896698B28dC1a7a508f0b87A'}  name={'ALIEN HORROR APES'} vaultId={2} contract={contract} cardName={'HAC Aliens'}  />
        </div>
      </div>
  )
}
