...
const Hac3333 = () => {
  ...
  return (
    <div className="bg-black min-h-screen mx-auto">
        ...
        <Staking tokenC={'0xAFc7647b584730694B9606511F11F423A0816eFf'} token={token} vaultC={'0x4d2Bfa7d1D13e6C13A08a92B32a238b2B6DFFE0E'}  name={'Hac 3333 Staking'} vaultId={1} contract={contract} cardName={'Hac 3333'}  />
        </div>
      </div>
  )
}
