...
const Hac3333 = () => {
  ...
  return (
    <div className="bg-black min-h-screen mx-auto">
        ...
        <Staking tokenC={'0xAFc7647b584730694B9606511F11F423A0816eFf'} token={token} vaultC={'0x60a00a6d716e2c2F896698B28dC1a7a508f0b87A'}  name={'HORROR APES'} vaultId={1} contract={contract} cardName={'HAC 3333'}  />
        </div>
      </div>
  )
}
