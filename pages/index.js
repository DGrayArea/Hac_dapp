...
const Home = () => {
  ...
  return (
    <div className="bg-[#0d0613] min-h-screen flex flex-col">
      ...
      <div className='text-white text-center px-5 py-3 rounded-md border-purple-300/20 border mx-4'>
       ...
       <div className='flex flex-col space-y-2 md:flex-row md:space-y-0 md:space-x-2 items-center justify-center'>
        ...
        <div className='stats-container justify-between'>
          ...
          <div className='stats'>  
          <span className='font-medium mr-6'>Total staked </span>
            <span className='font-bold ml-6'>{alienVaultBal?.length}/ 6666</span>
           </div>
          </div>
        </div>
        </div>
