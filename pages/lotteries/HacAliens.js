...
const HacAliens = () => {
  ...
  return (
    <div className="bg-black min-h-screen flex flex-col">
      <Lottery tokenString={'0x760ED02d9407372416155A5962092ba95ebc1290'} tContract={'0x120A9664D35031691eC7ee98B81F1A87ebbD1217'} admin={owner} contract={contract} name='Aliens' token={tokenContract} />
      </div>
  )
}
