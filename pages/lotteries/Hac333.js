...
const Hac333 = () => {
  ...
  return (
    <div className="bg-black min-h-screen flex flex-col">
      <Lottery tokenString={'0xB8e9e90cc512184082E8512a61C07206E8030C6d'} tContract={'0xceA4195AeCc3622179334e346cF526312F32D836'} admin={owner} contract={contract} name='333' token={tokenContract} />
      </div>
  )
}
