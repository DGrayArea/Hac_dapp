        ...
        <div className='space-y-5 md:space-y-0 m-5 md:flex md:flex-row items-start justify-center md:space-x-5'>
          ...
          <div className='flex justify-between p-2 space-x-2'>
            ...
            <div className='stats'>
              ...
              <p className='text-xl extra font-semibold text-yellow-400 flex flex-row justify-center'><span id='balance'>{0} &nbsp;</span>&nbsp;HACT&nbsp;  <Tooltip placement='leftStart' content={ <TooltipContent /> } rounded color="warning"> <InformationCircleIcon className='w-6' /></Tooltip></p>
            </div>
          </div>
          {/*countdown Timer */}
          ...
          <div className="stats-container">
            ...
            <div className='space-y-2 mt-5'>
             ...
             {/* <div className='flex items-center justify-between text-yellow-400 text-xs italic'>
                <p className='extra'>Service fees</p>
                <p className='extra'>0.0025 BNB</p>
          </div>*/}
