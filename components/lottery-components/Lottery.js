        ...
        <div className='space-y-5 md:space-y-0 m-5 md:flex md:flex-row items-start justify-center md:space-x-5'>
          ...
          <div className='flex justify-between p-2 space-x-2'>
            ...
            <div className='stats'>
              ...
              <p className='text-xl extra font-semibold text-yellow-400'><span id='balance'>{0}</span> HACT</p>
            </div>
          </div>
          {/*countdown Timer */}
        ...
        <div className='stats-container space-y-2'>
          <div className="stats-container">
            <div className='flex extra justify-between items-center text-white pb-2'>
              <h4 className='extra'>Price per ticket</h4>
          ...
          <div className='stats text-center'>
            <p className='text-lg extra mb-2'>You have {userEntries} tickets in this draw </p>
          </div>
        </div>
        </div>
        </div>
