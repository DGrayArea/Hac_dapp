...
import Nav from '../Nav'
import { useContractRead, useAddress, Web3Button, useContractWrite } from "@thirdweb-dev/react";
...
const Lottery = ({ name, admin, vaultId, contract, token, tokenString, tContract, endTime }) => {
        ...
        <div className='stats-container space-y-2'>
          <div className="stats-container">
            ...
            <div className='flex justify-center items-center text-center'>
                <Button css={{dflex:"center"}} auto color="warning" onPress={handler}>
                Approve to Enter
              </Button></div>
                      :
      ...
      >
        <Modal.Header>
          <Text b id="modal-title" size={18}>
            Please Re-Connect Wallet to Approve
          </Text>
        </Modal.Header>
        <Modal.Body>
        <Web3Button
