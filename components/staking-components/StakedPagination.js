  ...
  const nftArr = ['0x7E82F54578f03ad922F2bA61674C46b9dBdCE61d', '0xAFc7647b584730694B9606511F11F423A0816eFf', '0xE33cc98d90975Ad42e56251B0A1cd8bda9FAF003']
    ...
    callStaked();
      ...
      const callUnstake = async () => {
        ...
        try {
          const data = await unStake([ vaultId, selected, address ]);
      ...
      const callUnstakeAll = async () => {
        ...
        try {
          const data = await unStake([ vaultId, stkedNfts, address ]);
          console.info("contract call successs", data);
          toast.success("NFTs Unstaked Successfully", {
            id: notification,
          })
   ...
   <Grid.Container gap={2} justify='center'>
    ...
    <div className='grid grid-cols-2 md:hidden lg:hidden space-y-3 space-x-2 justify-center text-center mr-2 items-center'>
