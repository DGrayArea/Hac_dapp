...
const StakedPagination = ({ contract, cardName }) => {
    ...
    console.log(ownedNFTs, address, error)
      ...
      return (
        <div className='mx-auto'>
          <StakedCard contract={contract} cardName={cardName}  nftData={currentPosts} loading={isLoading} mobileData={currentMobilePosts}   />
          <StkPagination
