...
const NFTs = () => {
  ...
  const { contract } = useContract("0xB9cAa80147D8f3cF3A4D52965406b515d5ca6797");
  ...
  return (
    <div className="text-white text-center px-5 py-3 rounded-md border-yellow-400/20 border mx-4 mt-5">
