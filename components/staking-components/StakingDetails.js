 ...
 const address = useAddress()
  ...
  <div className='flex justify-between space-y-3 flex-col md:flex-row md:justify-between p-1 md:space-x-2'>
    ...
    <div className='stats'>
      ...
      <p className='text-xl extra flex flex-row justify-center items-center text-center text-yellow-400 font-semibold'><span id='balance'>{0}</span>&nbsp;HACT&nbsp;<Tooltip placement='leftStart' content={ <TooltipContent /> } rounded color="warning"> <InformationCircleIcon className='w-6' /></Tooltip></p>
    </div>
  </div>
